...
class TestUtils(unittest.TestCase):
    ...
    def test_non_overlapping_windows(self):
        ...
        self.assertTrue(np.array_equal(test_shape, expected_shape))

    def test_bin2df(self):
        input_path = "test_data/test_geneactiv.bin"
        expected_path = "test_data/test_geneactiv.csv"
        test_df = bin2df(input_path)
        expected_df = load_geneactiv_csv(expected_path)
        self.assertTrue(np.allclose(test_df, expected_df))
    ...
    def test_high_pass_filter(self):
        ...
        self.assertTrue(np.allclose(expected_output, test_output))
    ...
    def test_tst(self):
        ...
        self.assertEqual(expected_output, total_sleep_time(predictions))
    ...
    def test_waso(self):
        ...
        self.assertEqual(expected_output, wake_after_sleep_onset(predictions))
    ...
    def test_pta(self):
        ...
        self.assertEqual(expected_output, percent_time_asleep(predictions))
    ...
    def test_nwb(self):
        ...
        self.assertEqual(expected_output, number_of_wake_bouts(predictions))
    ...
    def test_sol(self):
        ...
        self.assertEqual(expected_output, sleep_onset_latency(predictions))
